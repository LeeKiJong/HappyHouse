...
public class MemberController {
	...
	public ResponseEntity<String> update(
			@RequestBody @ApiParam(value = "회원정보 수정 시 필요한 회원정보.", required = true) MemberDto memberDto,@PathVariable String userid, HttpServletRequest request) {
